...
// Your solution here (one-line arrow function):
exercise2Array.forEach(fruit => console.log(fruit.toUpperCase(exercise2Array)));

// Your solution here (regular arrow function):
exercise2Array.forEach((fruit) => {
  console.log(fruit.toUpperCase(exercise2Array));
});
...
// Your solution here (one-line arrow function):
exercise3Array.forEach(number => console.log(exercise3Sum += number));

exercise3Sum = 0;
// Your solution here (regular arrow function):
exercise3Array.forEach((number) => {
  console.log(exercise3Sum += number);
});
...
// Your solution here (one-line arrow function):
exercise5Array.forEach(squared => console.log(squared * squared));

// Your solution here (regular arrow function):
exercise5Array.forEach((squared) => {
