...
// Your solution here (one-line arrow function):
const exercise2Result1 = exercise2Array.filter(number => number >= 0);

// Your solution here (regular arrow function):
const exercise2Result2 = exercise2Array.filter((number) => {
  return number >= 0;
});
...
// Your solution here (one-line arrow function):
const exercise3Result1 = exercise3Array.filter(words => words.length > 4);

// Your solution here (regular arrow function):
const exercise3Result2 = exercise3Array.filter((words) => {
...
// Your solution here (one-line arrow function):
const exercise4Result1 = exercise4Array.filter(number => 20 < number && number < 50);

// Your solution here (regular arrow function):
const exercise4Result2 = exercise4Array.filter((number) => {
  return 20 < number && number < 50;
});
