...
const exercise1Result1 = exercise1Array.filter(x => x % 2 !== 0);

// Your solution here (regular arrow function):
const exercise1Result2 = exercise1Array.filter((x) => {
  return x % 2 !== 0;
});
...
// Your solution here (one-line arrow function):
const exercise2Result1 = exercise2Array.filter(words => words >= 5);

// Your solution here (regular arrow function):
const exercise2Result2 = exercise2Array.filter((words) => {
...
// Your solution here (one-line arrow function):
const exercise3Result1 = exercise3Array.filter(k => k > 10);

// Your solution here (regular arrow function):
const exercise3Result2 = exercise3Array.filter((k) => {
  return k > 10;
});
...
// Your solution here (one-line arrow function):
const exercise5Result1 = exercise5Array.filter(l => l % 4 === 0);

// Your solution here (regular arrow function):
const exercise5Result2 = exercise5Array.filter((l) => {
  return l % 4 === 0
});
