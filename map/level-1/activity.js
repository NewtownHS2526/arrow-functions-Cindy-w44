...
const exercise1Result1 = exercise1Array.map(numbers => numbers * 3);

// Your solution here (regular arrow function):
const exercise1Result2 = exercise1Array.map((numbers) => {
  return numbers * 3;
});
...
// Your solution here (one-line arrow function):
const exercise3Result1 = exercise3Array.map(number => number / 2);

// Your solution here (regular arrow function):
const exercise3Result2 = exercise3Array.map((number) => {
  return number / 2;
});
...
// Your solution here (one-line arrow function):
const exercise4Result1 = exercise4Array.map(animals => animals.toUpperCase() + "S");

// Your solution here (regular arrow function):
const exercise4Result2 = exercise4Array.map((animals) => {
  return animals.toUpperCase() + "S";
});
...
// Your solution here (one-line arrow function):
const exercise5Result1 = exercise5Array.map(squared => squared * squared);

// Your solution here (regular arrow function):
const exercise5Result2 = exercise5Array.map((squared) => {
