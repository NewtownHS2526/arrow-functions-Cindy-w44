...
const exercise1Result1 = exercise1Array.reduce((acc, curr) => curr % 2 === 0 ? acc + curr : acc, 0);
...
// Your solution here (one-line arrow function):
const exercise2Result1 = exercise2Array.reduce((acc, curr) => curr.age + acc, 0);
...
// Your solution here (one-line arrow function):
const exercise3Result1 = exercise3Array.reduce((acc, curr) => acc ? `${acc} - ${curr.toUpperCase()}` : curr.toUpperCase() ,"");
...
// Your solution here (one-line arrow function):
const exercise5Result1 = exercise5Array.reduce((acc, curr) => acc + (curr > 2), 0);
